...
do
  ...
  add_headerfiles("./include/(**.h)", { install = true, prefixdir = "" })
  add_includedirs("./include/", { public = true })
  add_files("./src/*.cpp")

  add_headerfiles("./thirdparty/osqp-cpp/include/(**.h)", { install = true, prefixdir = "" })
  add_includedirs("./thirdparty/osqp-cpp/include/", { public = true })
  add_files("./thirdparty/osqp-cpp/src/osqp++.cc")

  add_packages("highfive", "fmt", "osqp", "abseil", "eigen")
end
target_end()
